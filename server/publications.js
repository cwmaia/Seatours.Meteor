...
Meteor.publish('books', function() { 
  if(this.userId){
    ...
    return Books.find({}, {fields: {dateOfBooking: 1, 'trip._id': 1, 'trip.from': 1, 'trip.hour': 1, 'bookStatus' : 1, 'vehicle.totalCost' : 1, 'vehicle.category' : 1, 'vehicle.extraSlot' : 1, 'product._id' : 1, 'product.name':1, orderId : 1, totalISK:1,'vehicle.size' : 1, prices : 1}});
  }
});
